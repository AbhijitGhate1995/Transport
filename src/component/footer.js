...
const FooterData = () => {
  ...
  const TransitFlowHeader = (options) => {
    return (
      <div
        className="xl:flex flex-wrap items-center justify-center px-5 xl:mt-0 mt-2 py-2"
  ...
  const PageHeader = (options) => {
    return (
      <div
        className="xl:flex flex-wrap items-center justify-center px-4 xl:mt-0 mt-2"
        onClick={options.onClick}
      >
        <div className="flex items-center gap-2 md:mb-4 xl:mb-0 rubikFont">
          <span className="text-[24px] font-semibold text-white">Pages</span>
        </div>
      </div>
    );
  };
  const UtilityHeader = (options) => {
    return (
      ...
      >
        <div className="flex items-center gap-2 md:mb-4 xl:mb-0 rubikFont">
          <span className="text-[24px] font-semibold text-white">Utility</span>
        </div>
      </div>
    );
  };
    ...
    <div className="grid">
      <div className="w-full bg-[#091242] px-48 xl:flex flex-wrap pb-8">
        <div className="w-full grid grid-cols-1 items-center justify-start mb-8 Footer-Tab py-4">
          ...
          >
            <TabPanel
              headerTemplate={TransitFlowHeader}
              headerClassName={`flex align-items-center ${
                activeIndex === 0 ? "bg-[#091242]" : "bg-[#4E5683]"
              }`}
            >
            ...
            <TabPanel
              ...
              headerClassName={`flex align-items-center ${
                activeIndex === 1 ? "bg-[#091242]" : "bg-[#4E5683]"
              }`}
            >
              <div className="w-full flex justify-evenly items-center">
                <div className="grid xl:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 sm:grid-cols-2 gap-8">
            ...
            <TabPanel
              headerTemplate={UtilityHeader}
              headerClassName={`flex align-items-center ${
                activeIndex === 2 ? "bg-[#091242]" : "bg-[#4E5683]"
              }`}
            >
              <div className="w-full flex justify-evenly items-center">
                <div className="grid xl:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 sm:grid-cols-2 gap-8">
            ...
            <TabPanel
              headerTemplate={SubscribeHeader}
              headerClassName={`flex align-items-center ${
                activeIndex === 3 ? "bg-[#091242]" : "bg-[#4E5683]"
              }`}
            >
              <div className="text-[white] h-auto">
                Subscribe to Tranport & Logistic WebFlow
              </div>
              <div className="text-[#fff] grid">
                <span>Leverage agile frameworks to provide a robust</span>
