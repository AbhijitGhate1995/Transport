      ...
      <div className="bg-white mx-60 xl:my-0 md:my-20 my-[500px]">
        <div className="w-full grid bg-[#fff] mt-[100px] pb-20 mb-20">
          <div className="flex flex-col justify-center items-center text-[35px] font-bold xl:text-[1.823vw] pt-20 gap-8">
            <div className="gap-4 text-[#1C1F35] rubikFont text-[350px] xl:text-[18.229vw]">
            ...
            <div className="send-grad send-hover mt-6 flex gap-2 krubFont cursor-pointer">
              <Link to="/">
                <div className="">
                  <span className="text-[16px] xl:text-[0.833vw] flex justify-center items-center mt-4 ml-4 text-[#23212A] font-semibold">
                    Back To Home
                  </span>
                </div>
              </Link>
