  ...
  return (
    <div className="bg-[#F4F4F4] mt-4 pb-20">
      <div className="w-full flex flex-wrap justify-evenly items-center">
        ...
        <div className="mt-16">
          <div className="absolute bg-[#111C55] px-8 py-6 grid 2xl:top-[2300px] 2xl:left-[900px] gap-4 z-10 
          xl:top-[1850px] xl:left-[550px] lg:top-[2300px] md:top-[2900px] sm:top-[4050px]">
