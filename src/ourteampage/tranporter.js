...
import Ria from "../images/ourteam/ria.png";
import Kane from "../images/ourteam/kane.png";
import Lisara from "../images/ourteam/lisara.png";
import "../App.css";

const TeamTranporter = () => {
  return (
    <div>
